    ...
    #define LED_PIN             17
    #define IFTTT_PIN           12  // This pin is also used by the JTAG interface (TDI, see https://docs.espressif.com/projects/esp-idf/en/latest/esp32/api-guides/jtag-debugging/configure-other-jtag.html)
    #define WIFI_LED            16
